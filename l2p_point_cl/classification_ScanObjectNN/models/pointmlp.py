...
# Hack to use local pointnet_util instead of missing pointnet2_ops
import sys
import os
try:
    from models import pointnet_util
except ImportError:
    # Try different path if models package not found
    sys.path.append(os.path.dirname(__file__))
    import pointnet_util

class PointNet2UtilsMock:
    @staticmethod
    def furthest_point_sample(xyz, npoint):
        return pointnet_util.farthest_point_sample(xyz, npoint)

pointnet2_utils = PointNet2UtilsMock()
